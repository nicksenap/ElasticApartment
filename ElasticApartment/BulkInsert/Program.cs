...
namespace ElasticApartment.Insert
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var properties = JsonConvert.DeserializeObject<List<PropertyItem>>(File.ReadAllText("C:\\Users\\nsong\\Downloads\\properties.json"))
                .Select(x => x.Property);
            var mgmts = JsonConvert.DeserializeObject<List<ManagementItem>>(File.ReadAllText("C:\\Users\\nsong\\Downloads\\mgmt.json"))
